...
print(set5)
print(set5[-1])
print(set5[len(set5) - 1]) ## same as above


# how to insert elements in the set "using add"
set6 = set()
set6.add(1)
set6.add(1)
set6.add(2)
...
# # union operation
print('union operation is = ',set_a | set_b)

# intersection operation
print('intersection operation is = ',set_a & set_b)
